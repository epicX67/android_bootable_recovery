...
ifneq ($(SHRP_MAINTAINER_NAME),)
	LOCAL_CFLAGS += -DSHRP_MAINTAINER_NAME=$(SHRP_MAINTAINER_NAME)
endif
ifneq ($(SHRP_PRODUCT),)
	LOCAL_CFLAGS += -DSHRP_PRODUCT=$(SHRP_PRODUCT)
endif
ifneq ($(SHRP_EDL),)
	LOCAL_CFLAGS += -DSHRP_EDL=$(SHRP_EDL)
endif
ifneq ($(SHRP_EXTERNAL_MOUNT),)
	LOCAL_CFLAGS += -DSHRP_EXTERNAL_MOUNT=$(SHRP_EXTERNAL_MOUNT)
endif
ifneq ($(SHRP_INTERNAL_MOUNT),)
	LOCAL_CFLAGS += -DSHRP_INTERNAL_MOUNT=$(SHRP_INTERNAL_MOUNT)
endif
ifneq ($(SHRP_OTG_MOUNT),)
	LOCAL_CFLAGS += -DSHRP_OTG_MOUNT=$(SHRP_OTG_MOUNT)
endif
